# Mint Skill — Developer Portfolio & Skill Verification Platform
...
| ฟีเจอร์                     | รายละเอียด                                                          |
| --------------------------- | ------------------------------------------------------------------- |
| **Auto-Mint Badge**         | เมื่อ Skill ได้รับ Endorsement ครบตามเกณฑ์ (1 คน สำหรับ Lvl 1, 3 คน สำหรับ Lvl 2, 5 คน สำหรับ Lvl 3) และผ่านแบบทดสอบ AI Quiz ครบถ้วน ระบบจะทำสร้าง Badge อัตโนมัติ |
| **Tech Logo Integration**   | **(New)** ดึงภาพ Tech Logo จริงมาแสดงบนบัดจ์แทนไอคอนเริ่มต้นทั่วไป เพื่อความสวยงามพรีเมียม |
| **E-Certificate Modal**     | **(New)** หน้า Modal ใบรับรองดิจิทัลแบบหรูหรา ใช้คู่สีกรอบและป้ายระดับบ่งบอกความเชี่ยวชาญ (Junior, Middle, Senior) พร้อมตราประทับ Certified และติ๊กถูกสีเขียวมรกตเด่นชัด |
| **Secure Date Formatting**  | **(New)** ระบบจัดการฟอร์แมตวันเวลา Issued Date ปลอดภัย ไร้ปัญหาข้อผิดพลาดวันแสดงผลเป็น "Invalid Date" |
...
| **Repo Spotlight**     | **(New)** สลับสถานะการไฮไลต์ (Spotlight) โดยการเน้นด้วยเส้นขอบหนาเรียบหรู (Solid Border) แทนการเรืองแสงฉูดฉาด เพื่อปักหมุดโครงการเด่นขึ้นแสดงในหน้า Public Profile |
| **Dashboard Card**     | แสดงสถานะ GitHub (Connected/Not Connected) พร้อม Stats และปุ่ม Sync Profile ที่ถูกจัดวางไว้ตำแหน่งมุมขวาบนอย่างลงตัว |
...
1. การขอรับรองผ่าน Link:
   ...
   - ระบบบันทึก Endorsement → อัปเดต endorsementCount ใน Skill (นับตามจำนวนการยืนยันจริง)
   - ถ้าคะแนนสะสมและคะแนนสอบผ่านเกณฑ์ → Auto-Mint Badge
...
| **AI Integration**    | Gemini API (AI quiz generation microservice)               |
...
| `badges`       | Badge ที่ได้รับอัตโนมัติ    | `userId`, `skillId`, `skillName`, `earnedAt`, `level`                                               |
...
| `/dashboard`         | Dashboard        | หน้าหลัก — Profile + 5 Tabs (Overview, Skills, Endorsements, Gap Analysis, Export Resume)      |
