          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center pt-8 pb-4 px-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">{activeBadge.name}</h3>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 mb-4 overflow-hidden">
                  <div className="flex bg-white dark:bg-slate-700 border-b border-slate-200/50 dark:border-slate-600/50">
                    <div className="flex-1 text-center border-r border-slate-200/50 dark:border-slate-600/50 p-3">
                      ...
                      <p className="text-lg text-green-500 dark:text-green-400 font-black">{Math.min(15, activeBadge.quizScore + activeBadge.endorsementScore)}<span className="text-xs text-slate-400 dark:text-slate-500">/15</span></p>
                    </div>
                    <div className="flex-1 text-center border-r border-slate-200/50 dark:border-slate-600/50 p-3">
                      <p className="text-[9px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest mb-0.5">Endorse</p>
                      <p className="text-lg text-slate-800 dark:text-slate-200 font-bold">{Math.min(5, activeBadge.endorsementScore)}<span className="text-xs text-slate-400 dark:text-slate-500">/5</span></p>
                    </div>
                    <div className="flex-1 text-center p-3">
                      ...
                      <p className="text-lg text-slate-800 dark:text-slate-200 font-bold">{Math.min(10, activeBadge.quizScore)}<span className="text-xs text-slate-400 dark:text-slate-500">/10</span></p>
                    </div>
                  </div>
                </div>
