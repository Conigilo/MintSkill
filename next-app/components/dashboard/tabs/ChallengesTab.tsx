...
//         <h3 className="text-xl font-bold text-slate-900">Coding Challenges</h3>
//       </div>
...
//         </div>
//       ) : challenges.length === 0 ? (
//         <div className="text-center p-8 glass-panel rounded-2xl border border-slate-200">
//           <p className="text-slate-500">No challenges available yet. Check back later!</p>
//         </div>
//       ) : (
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//           {challenges.map((c) => (
//             <div key={c.id} className="p-5 glass-panel rounded-2xl border border-slate-200 flex flex-col justify-between">
//               <div>
...
//                 </p>
//                 <div className="bg-slate-50 border border-slate-200 p-3 rounded-xl mb-4 font-mono text-xs text-blue-400 overflow-x-auto">
...
//                   }}
//                   className="w-full bg-[#111110] hover:bg-[#1a1a19] text-slate-900 py-2 rounded-xl transition-colors text-sm font-medium border border-slate-200"
//                 >
//                   Copy Link
//                 </button>
//               </div>
//             ) : (
//               <>
//                 <h3 className="text-xl font-bold text-slate-900 mb-1">Submit Challenge</h3>
//                 <p className="text-sm text-slate-500 mb-6">Enter the URL to your project repository or live site.</p>
...
//                       className="w-full bg-white border border-slate-200 text-slate-900 px-4 py-3 rounded-xl focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
//                     />
//                   </div>
//                   <button
//                     type="submit"
//                     className="w-full bg-blue-600 hover:bg-blue-700 text-slate-900 py-3 rounded-xl transition-colors font-medium text-sm disabled:opacity-50"
//                   >
