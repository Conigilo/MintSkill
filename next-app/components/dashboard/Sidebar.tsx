...
// //   //       <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#1f6feb] to-[#58a6ff] flex items-center justify-center font-serif text-[32px] font-semibold text-slate-900 border-[3px] border-[var(--border)]">
// //   //         {p.initial}
// //   //       </div>
