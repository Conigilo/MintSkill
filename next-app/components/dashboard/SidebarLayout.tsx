...
export default function SidebarLayout({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-slate-800 font-sans">
      {/* Sidebar */}
      <aside className="w-64 border-r border-slate-200/50 bg-white hidden md:flex flex-col p-4 pt-2 sticky top-0 h-screen z-50">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-colors font-medium ${isActive
