    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0d1117] flex flex-col items-center justify-center p-6 relative selection:bg-indigo-500/20">
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#161b22] border border-slate-200/70 dark:border-[#30363d] p-8 rounded-2xl shadow-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Create Account</h1>
          <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">Join the verified developer portfolio community.</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 text-sm cursor-pointer shadow-sm"
          >
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-3 text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider">or sign up with email</span>
          <div className="flex-1 border-t border-slate-200/50 dark:border-[#30363d]"></div>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest pl-0.5">Full Name</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest pl-0.5">Password</label>
            <input
              type="password"
              required
              value={password}
