...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen bg-[#090d14] flex flex-col items-center justify-center p-4">

            {/* Badge */}
            <div className="mb-8 bg-[#161b22] border border-gray-800 px-4 py-1.5 rounded-full flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span className="text-xs text-gray-300 font-bold tracking-wider uppercase">SKILL WALLET</span>
            </div>

            {/* Main Card */}
            <div className="w-full max-w-md bg-[#161b22] border border-gray-800/60 p-10 rounded-[2rem] shadow-2xl">

                {/* Logo */}
                <div className="w-14 h-14 bg-[#090d14] border border-gray-800 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <span className="text-2xl font-black text-purple-500">S.</span>
                </div>

                {/* Header */}
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-black text-white mb-2 font-serif tracking-tight">CREATE ACCOUNT</h1>
                    <p className="text-gray-400 text-sm">Join us to build your verified portfolio.</p>
                </div>
                ...
                <form onSubmit={handleSignUp} className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-[#090d14] border border-gray-800 text-white rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:border-purple-500 transition-colors"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 00-2 2z"></path></svg>
                            </div>
                            <input
                                type="email"
                                value={email}
                    ...
                    <button
                        ...
                        className="w-full bg-[#8b5cf6] hover:bg-[#7c3aed] text-white font-bold py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)] mt-2 flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                ...
                <div className="flex items-center my-8">
                    ...
                    <span className="px-4 text-[10px] text-gray-500 font-bold uppercase tracking-widest">Or continue with</span>
                    <div className="flex-1 border-t border-gray-800"></div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-[#090d14] border border-gray-800 hover:border-gray-600 text-white font-bold py-3 rounded-xl transition-colors"
                    >
