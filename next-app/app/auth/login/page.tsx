    ...
    <div className="min-h-screen bg-[var(--background)] text-slate-900 flex items-center justify-center font-sans relative overflow-hidden selection:bg-purple-500/30">
      ...
      <div className="w-full max-w-[440px] px-6 relative z-10 my-10">
        ...
        <div className="absolute -top-16 left-0 right-0 flex justify-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[var(--border)] bg-[var(--card)] text-[11px] font-bold tracking-widest uppercase text-slate-500">
