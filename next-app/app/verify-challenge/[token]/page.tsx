      ...
      <div className="max-w-2xl mx-auto pt-24 px-6">
        {error ? (
          <div className="text-center p-12 glass-panel rounded-3xl border border-red-500/30">
            ...
            <button
              onClick={() => router.push("/")}
              className="mt-6 bg-gray-800 hover:bg-gray-700 px-6 py-2 rounded-xl text-white transition-colors"
            >
              Back to Home
            </button>
          </div>
          ...
          <div className="text-center p-12 glass-panel rounded-3xl border border-green-500/30">
            ...
            <button
              onClick={() => router.push("/")}
              className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-xl text-white transition-colors font-medium shadow-lg shadow-blue-900/50"
            >
              Go to Home
            </button>
          </div>
          ...
          <div className="glass-panel p-8 rounded-3xl border border-gray-800 relative overflow-hidden">
            ...
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-white mb-2">Verify Challenge Attempt</h1>
            ...
            <div className="bg-[#0d1117] border border-gray-800 rounded-2xl p-6 mb-8">
              <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Submission Details</h3>
              
              <div className="space-y-4">
                <div>
                  <p className="text-xs text-gray-500 mb-1">Challenge URL / Project Link</p>
                  <a 
                ...
                <div>
                  ...
                  <p className="text-gray-300">{new Date((attempt?.createdAt?._seconds || 0) * 1000 || Date.now()).toLocaleDateString()}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#161b22] border border-gray-700 text-white px-4 py-3 rounded-xl focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all resize-none h-32"
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3.5 rounded-xl transition-colors font-medium text-sm disabled:opacity-50 shadow-lg shadow-blue-900/50"
                >
